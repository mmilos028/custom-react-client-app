...
type MemberCardBarcodeToPrintProps = {
...
class MemberCardBarcodeToPrint extends React.Component<MemberCardBarcodeToPrintProps> {
  state = {
  };
                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{ padding: "0", margin: "0", textAlign: 'center' }} colSpan={2}>
                            ...
                            <Barcode value={this.props['card_prepaid_code']} format="CODE128" displayValue={false} margin={3} width={1.5} height={60} />
                            }
                        </td>
                    </tr>
                    <tr>
...
export default MemberCardBarcodeToPrint;