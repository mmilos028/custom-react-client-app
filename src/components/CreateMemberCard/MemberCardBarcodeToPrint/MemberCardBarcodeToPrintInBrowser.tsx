...
type MemberCardBarcodeToPrintInBrowserProps = {
...
class MemberCardBarcodeToPrintInBrowser extends React.Component<MemberCardBarcodeToPrintInBrowserProps> {
  state = {
  };
                ...
                <tbody>
                    <tr>
                        <td style={{ maxHeight: "5mm", textAlign: "center", padding: "0", margin: "0" }} colSpan={2}>
                            <span style={{ fontSize: "5mm", fontWeight: "normal", color: "rgb(0, 0, 0)" }}>
                                Amount:
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style={{ padding: "0", margin: "0", textAlign: 'center' }} colSpan={2}>
                            { this.props['card_prepaid_code'] &&
                                <Barcode value={'$$1234567890123456'} format="CODE128" displayValue={false} margin={3} width={1.5} height={60} />
                            }
                        </td>
                    </tr>
                    <tr>
                        <td style={{ width: '50%', textAlign: 'left', maxHeight: "3mm", padding: "0", margin: "0" }}>
                            <span style={{ fontSize: '3mm' }}>
                                Serial number:
                            </span>
                        </td>
                        <td style={{ width: '50%', textAlign: 'right', maxHeight: "3mm", padding: "0", margin: "0" }}>
...
export default MemberCardBarcodeToPrintInBrowser;