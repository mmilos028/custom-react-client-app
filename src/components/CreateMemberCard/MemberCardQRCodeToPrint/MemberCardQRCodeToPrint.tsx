...
type MemberCardQRCodeToPrintProps = {
...
class MemberCardQRCodeToPrint extends React.Component<MemberCardQRCodeToPrintProps> {
  state = {
  };
                ...
                <tr>
                    <td style={{ padding: "0", margin: "0", textAlign: 'center' }} colSpan={2}>
                        { 
                            ...
                            <QRCode value={ (GAME_CLIENT_URL + (this.props['card_prepaid_code'].replace("$$", "")) )} level='H' size={100} />
                        }
                    </td>
                </tr>
                <tr>
...
export default MemberCardQRCodeToPrint;